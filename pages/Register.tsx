                ...
                <div className="w-full max-w-[480px] flex flex-col gap-6">
                    ...
                    <div className="w-full overflow-hidden rounded-xl h-48 relative shadow-lg">
                        ...
                        <div className="absolute bottom-4 left-4 z-20">
                            <h2 className="text-white text-xl font-bold">Crie sua conta</h2>
                            <p className="text-gray-300 text-sm">Comece sua jornada hoje</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-2">
                        ...
                        <div className="flex flex-col gap-1.5">
                            <label className="text-sm font-medium text-[#111418] dark:text-gray-200" htmlFor="confirmPassword">Confirmar Senha</label>
                            <div className="relative">
                                <input
                                    id="confirmPassword"
                                    type={showPassword ? "text" : "password"}
                    ...
                    <div className="mt-4 text-center">
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            Já tem uma conta?
                            <Link to="/login" className="font-bold text-primary hover:underline ml-1">Fazer login</Link>
                        </p>
                    </div>
                </div>
            </div>
